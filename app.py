...
math_chain=LLMMathChain.from_llm(llm=llm) #This specific LLMMathChain is used for mathematical operations. It will interact with LLM model with respect to any kind of calculation or any kind of arithmetic calculations that needs to be performed.
...
#Now we are converting LLMChain into a tool
reasoning_tool=Tool(
    name="Reasoning tool",
    func=chain.run,
